...
const kept = normalizeUpstreamInput({ name: 'b-ai', shape: 'responses', baseUrl: 'https://relay.example.com/v1', models: 'x', dailyRequestBudget: '5' }, entry)
...
assert.equal(suggestBaseUrlFix(record, 'https://relay.example.com/v1/models'), '', 'base_url 已带版本段')
