...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://github.com/univers629/dsh-docker/pulls)
...
### Linux / macOS Users
```bash
git clone https://github.com/univers629/dsh-docker.git
cd dsh-docker
./start.sh
```
